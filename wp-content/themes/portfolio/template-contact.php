...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
    <main class="layout contact">
        <h2 class="contact__title">Contactez-moi <span class="sro">Natacha Belboom</span></h2>
        <div class="contact__informations" itemscope itemtype="https://schema.org/Person">
            <p>Vous aimez ce que je fais? Envoyez-moi un mail ou contactez-moi sur mes réseaux sociaux!</p>
            <h3>Mes informations</h3>
            <ul class="contact__informations--list">
                <li class="contact__informations--item">
